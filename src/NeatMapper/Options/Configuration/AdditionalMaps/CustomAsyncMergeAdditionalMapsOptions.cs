...
namespace NeatMapper {
	...
	public sealed class CustomAsyncMergeAdditionalMapsOptions {
		...
		public void AddMap<TSource, TDestination>(AsyncMergeMapDelegate<TSource, TDestination> mapDelegate, CanMapAsyncMergeDelegate<TSource, TDestination>? canMapDelegate) {
		...
		/// <param name="mapDelegate">Mapping method to use.</param>
		/// <param name="canMapDelegate">Optional check method which will be called before the mapping method.</param>
		public void TryAddMap<TSource, TDestination>(AsyncMergeMapDelegate<TSource, TDestination> mapDelegate, CanMapAsyncMergeDelegate<TSource, TDestination>? canMapDelegate) {
			AddMapInternal(mapDelegate, canMapDelegate, false);
		}


		private void AddMapInternal<TSource, TDestination>(AsyncMergeMapDelegate<TSource, TDestination> mapDelegate, CanMapAsyncMergeDelegate<TSource, TDestination>? canMapDelegate, bool throwOnDuplicate) {
			if (mapDelegate == null)
			...
			if(canMapDelegate != null){
				CanMapAsyncMergeDelegate<TSource, TDestination> method2 = canMapDelegate.Invoke;
