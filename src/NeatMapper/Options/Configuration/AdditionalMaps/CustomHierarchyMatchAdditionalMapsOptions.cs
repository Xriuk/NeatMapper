...
namespace NeatMapper {
	...
	public sealed class CustomHierarchyMatchAdditionalMapsOptions {
		...
		public void AddMap<TSource, TDestination>(HierarchyMatchMapDelegate<TSource, TDestination> mapDelegate, CanMatchHierarchyDelegate<TSource, TDestination>? canMapDelegate) {
		...
		/// <param name="mapDelegate">Mapping method to use.</param>
		/// <param name="canMapDelegate">Optional check method which will be called before the mapping method.</param>
		public void TryAddMap<TSource, TDestination>(HierarchyMatchMapDelegate<TSource, TDestination> mapDelegate, CanMatchHierarchyDelegate<TSource, TDestination>? canMapDelegate) {
			AddMapInternal(mapDelegate, canMapDelegate, false);
		}


		private void AddMapInternal<TSource, TDestination>(HierarchyMatchMapDelegate<TSource, TDestination> mapDelegate, CanMatchHierarchyDelegate<TSource, TDestination>? canMapDelegate, bool throwOnDuplicate) {
			if (mapDelegate == null)
			...
			if(canMapDelegate != null){
				CanMatchHierarchyDelegate<TSource, TDestination> method2 = canMapDelegate.Invoke;
