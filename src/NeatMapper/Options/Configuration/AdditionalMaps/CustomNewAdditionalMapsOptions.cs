...
namespace NeatMapper {
	...
	public sealed class CustomNewAdditionalMapsOptions {
		/// <summary>
		/// Creates a new instance of <see cref="CustomNewAdditionalMapsOptions"/>.
		/// </summary>
		...
		public void AddMap<TSource, TDestination>(NewMapDelegate<TSource, TDestination> mapDelegate, CanMapNewDelegate<TSource, TDestination>? canMapDelegate) {
		...
		/// <param name="mapDelegate">Mapping method to use.</param>
		/// <param name="canMapDelegate">Optional check method which will be called before the mapping method.</param>
		public void TryAddMap<TSource, TDestination>(NewMapDelegate<TSource, TDestination> mapDelegate, CanMapNewDelegate<TSource, TDestination>? canMapDelegate) {
			AddMapInternal(mapDelegate, canMapDelegate, false);
		}


		private void AddMapInternal<TSource, TDestination>(NewMapDelegate<TSource, TDestination> mapDelegate, CanMapNewDelegate<TSource, TDestination>? canMapDelegate, bool throwOnDuplicate) {
			if (mapDelegate == null)
			...
			if(canMapDelegate != null){
				CanMapNewDelegate<TSource, TDestination> method2 = canMapDelegate.Invoke;
