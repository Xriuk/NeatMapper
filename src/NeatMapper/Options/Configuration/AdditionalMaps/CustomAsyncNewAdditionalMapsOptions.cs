...
namespace NeatMapper {
	...
	public sealed class CustomAsyncNewAdditionalMapsOptions {
		...
		public void AddMap<TSource, TDestination>(AsyncNewMapDelegate<TSource, TDestination> mapDelegate, CanMapAsyncNewDelegate<TSource, TDestination>? canMapDelegate) {
		...
		/// <param name="mapDelegate">Mapping method to use.</param>
		/// <param name="canMapDelegate">Optional check method which will be called before the mapping method.</param>
		public void TryAddMap<TSource, TDestination>(AsyncNewMapDelegate<TSource, TDestination> mapDelegate, CanMapAsyncNewDelegate<TSource, TDestination>? canMapDelegate) {
			AddMapInternal(mapDelegate, canMapDelegate, false);
		}


		private void AddMapInternal<TSource, TDestination>(AsyncNewMapDelegate<TSource, TDestination> mapDelegate, CanMapAsyncNewDelegate<TSource, TDestination>? canMapDelegate, bool throwOnDuplicate) {
			if (mapDelegate == null)
