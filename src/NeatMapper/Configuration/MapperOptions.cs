...
namespace NeatMapper.Configuration {
	...
	public sealed class MapperOptions : IAdditionalMapsOptions {
		...
		IDictionary<(Type From, Type To), AdditionalMap> IAdditionalMapsOptions.NewMaps  => _newMaps;
		IDictionary<(Type From, Type To), AdditionalMap> IAdditionalMapsOptions.MergeMaps => _mergeMaps;
