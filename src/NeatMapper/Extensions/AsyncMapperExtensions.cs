...
#nullable enable
		...
		/// <returns>A task which will return true if an object of <paramref name="destinationType"/> can be created from a parameter of <paramref name="sourceType"/></returns>
		/// <exception cref="InvalidOperationException">Could not verify if the mapper supports the given types</exception>
		public static async Task<bool> CanMapAsyncNew(this IAsyncMapper mapper, Type sourceType, Type destinationType, CancellationToken cancellationToken = default) {
...
#nullable disable
			...
			if (mapper is IAsyncMapperCanMap mapperCanMap)
				return await mapperCanMap.CanMapAsyncNew(sourceType, destinationType, cancellationToken);
			...
			try {
				await mapper.MapAsync(source, sourceType, destinationType, null, cancellationToken);
				return true;
			}
...
#nullable enable
		...
		/// <typeparam name="TDestination">Type of the destination object to create, used to retrieve the available maps</typeparam>
		/// <param name="cancellationToken">Cancellation token used to interrupt asynchronous operations</param>
		/// <returns>A task which will return true if an object of <typeparamref name="TDestination"/> can be created from a parameter of <typeparamref name="TSource"/></returns>
		/// <exception cref="InvalidOperationException">Could not verify if the mapper supports the given types</exception>
		public static Task<bool> CanMapAsyncNew<TSource, TDestination>(this IAsyncMapper mapper, CancellationToken cancellationToken = default) {
			return mapper.CanMapAsyncNew(typeof(TSource), typeof(TDestination));
		}
		...
		/// <param name="destinationType">Type of the destination object, used to retrieve the available maps</param>
		/// <param name="cancellationToken">Cancellation token used to interrupt asynchronous operations</param>
		/// <returns>A task which will return true if an object of <paramref name="sourceType"/> can be merged into an object of <paramref name="destinationType"/></returns>
		/// <exception cref="InvalidOperationException">Could not verify if the mapper supports the given types</exception>
		public static async Task<bool> CanMapAsyncMerge(this IAsyncMapper mapper, Type sourceType, Type destinationType, CancellationToken cancellationToken = default) {
...
#nullable disable
			...
			// Check if the mapper implements IMapperCanMap, if it throws it means that the map can be checked only when mapping
			if (mapper is IAsyncMapperCanMap mapperCanMap)
				return await mapperCanMap.CanMapAsyncMerge(sourceType, destinationType, cancellationToken);
			...
			try {
				await mapper.MapAsync(source, sourceType, destination, destinationType, null, cancellationToken);
				return true;
			}
			catch (MapNotFoundException) {
				return false;
...
#nullable enable
		...
		/// <typeparam name="TDestination">Type of the destination object, used to retrieve the available maps</typeparam>
		/// <param name="cancellationToken">Cancellation token used to interrupt asynchronous operations</param>
		/// <returns>A task which will return true if an object of <typeparamref name="TSource"/> can be merged into an object of <typeparamref name="TDestination"/></returns>
		/// <exception cref="InvalidOperationException">Could not verify if the mapper supports the given types</exception>
		public static Task<bool> CanMapAsyncMerge<TSource, TDestination>(this IAsyncMapper mapper, CancellationToken cancellationToken = default) {
			return mapper.CanMapAsyncMerge(typeof(TSource), typeof(TDestination), cancellationToken);
		} 
		#endregion
	}
}
