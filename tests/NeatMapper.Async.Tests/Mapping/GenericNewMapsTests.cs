...
namespace NeatMapper.Tests.Mapping {
	...
	public class GenericNewMapsTests {
		...
		public Task ShouldMapDeepGenerics() {
			...
			// Does not throw
			return _mapper.MapAsync<IDictionary<string, IDictionary<int, IList<bool>>>, IEnumerable<bool>>(objectToMap);
		}
		...
		public async Task ShouldMapCollections() {
			{
				var tuples = await _mapper.MapAsync<ValueTuple<int, string>[]>(new[] { new Tuple<string, int>("Test1", 4), new Tuple<string, int>("Test2", 5) });
			...
			{
				var tuples = await _mapper.MapAsync<IList<ValueTuple<int, string>>>(new[] { new Tuple<string, int>("Test1", 4), new Tuple<string, int>("Test2", 5) });
			...
			{
				var tuples = await _mapper.MapAsync<LinkedList<ValueTuple<int, string>>>(new[] { new Tuple<string, int>("Test1", 4), new Tuple<string, int>("Test2", 5) });
			...
			{
				var tuples = await _mapper.MapAsync<Queue<ValueTuple<int, string>>>(new[] { new Tuple<string, int>("Test1", 4), new Tuple<string, int>("Test2", 5) });
			...
			{
				var tuples = await _mapper.MapAsync<Stack<ValueTuple<int, string>>>(new[] { new Tuple<string, int>("Test1", 4), new Tuple<string, int>("Test2", 5) });
			...
			{
				var tuples = await _mapper.MapAsync<CustomCollection<ValueTuple<int, string>>>(new[] { new Tuple<string, int>("Test1", 4), new Tuple<string, int>("Test2", 5) });
