...
namespace NeatMapper.Tests.Mapping {
	...
	public class EnumMapperTests {
		...
		[TestMethod]
		public void ShouldConvertToUnderlyingTypeHashedName() {
		...
		[TestMethod]
		public void ShouldConvertFromUnderlyingTypeHashedName() {
			var options = new MappingOptions(new EnumMapperMappingOptions(null, EnumToNumberMapping.HashedName, null));
		...
		[TestMethod]
		public void ShouldConvertToOtherEnumByValue() {
		...
		[TestMethod]
		public void ShouldConvertToOtherEnumByCaseInsensitiveName() {
		...
		[TestMethod]
		public void ShouldConvertToOtherEnumByCaseSensitiveName() {
